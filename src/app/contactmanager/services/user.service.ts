...
export class UserService {
  ...
  loadAll(): Observable<User[]> {  //loadAll() {
    ...
    //      .pipe(map(
    //          response =>
                //this.dataStore.users = response as User[]
    //          ));
